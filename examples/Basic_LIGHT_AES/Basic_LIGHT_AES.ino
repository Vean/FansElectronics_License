...
// EN: Create FansElectronics_License object in LIGHT_AES mode
// ID: Buat objek FansElectronics_License dalam mode LIGHT_AES
FansElectronics_License license(doc, FEL_MODE_LIGHT_AES); // JSON doc, Encryption Type
...
void setup()
{
  ...
  // EN: LIGHT_AES → verification use Device ID and AES Key
  // ID: LIGHT_AES → verifikasi menggunakan Device ID dan Kunci AES
